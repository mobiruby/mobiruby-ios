  ...
  archs.each do |arch|
    MRuby::CrossBuild.new(arch) do |conf|
      ...
      [conf.cc, conf.cxx, conf.objc].each do |cc|
        ...
        cc.include_paths << "#{File.dirname(__FILE__)}/submodules/mruby/build/libffi/include"
      ...
      conf.linker.library_paths << "#{File.dirname(__FILE__)}/submodules/mruby/build/libffi"
